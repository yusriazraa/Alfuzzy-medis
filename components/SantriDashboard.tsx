...
const SantriDashboard: React.FC<SantriDashboardProps> = ({ user, navigateTo }) => {
  return (
    <div className="container mx-auto p-6 my-10">
      <h2 className="text-3xl font-bold text-gray-800">Selamat Datang, {user.name}!</h2>
      <p className="text-gray-600 mt-2 mb-8">Ini adalah halaman utama Anda. Silakan pilih menu di bawah untuk memulai.</p>
      <div className="grid md:grid-cols-2 gap-6">
        <ActionCard
            title="Screening Kesehatan"
            description="Mulai pemeriksaan gejala mandiri untuk mengetahui kondisi kesehatan Anda saat ini."
            ...
            onClick={() => navigateTo(Page.SCREENING)}
        />
        <ActionCard
            title="Riwayat Kesehatan"
            description="Lihat kembali hasil screening dan catatan kesehatan Anda sebelumnya."
        ...
        />
         <ActionCard
            ...
            description="Baca artikel dan informasi penting untuk menjaga kesehatan di lingkungan pesantren."
